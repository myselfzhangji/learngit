...
#define watcgdog_timeoutValue  4000   //timeoutvalue=2000,2s
#define watcgdog_windowValue  3000 //windowvalue=1000,实际watchdog时间=watcgdog_timeoutValue-watcgdog_windowValue
...
//  WDOG_clockSource_Frequency = CLOCK_GetFreq(kCLOCK_BusClk);
  ...
  watchgdog_config.enableWindowMode = true;
  watchgdog_config.windowValue = (WDOG_clockSource_Frequency/1000) * watcgdog_windowValue;
